   ...
   TypeVal typeEval() {
      if (expList != null) {
         ...
         if (elist == TypeVal.Int){
            //System.out.println("~~~Mul operand type: " + TypeVal.Int);
            return TypeVal.Int;
         }
         else if (elist == TypeVal.Float){
            //System.out.println("~~~Mul operand type: " + TypeVal.Float);
            return TypeVal.Float;
         }
         else{
            TypeChecker.displayln("Type Error: some arguments of Mul'*' Operator have incompatible types.");
